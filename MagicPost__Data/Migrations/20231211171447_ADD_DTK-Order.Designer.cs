            ...
            modelBuilder.Entity("MagicPost__Data.Entities.AppRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "762d3678-8c84-4b81-a7e6-93ec416eeb55",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "3c8510cb-13b3-41a7-8a2b-5169b96bf13d",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "efffc7cb-20a2-4f4f-a3ab-d991ea88d868",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "653bea68-c0dd-4e13-8819-e920dea7f20c",
            ...
            modelBuilder.Entity("MagicPost__Data.Entities.AppUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("8d04dce2-969a-435d-bba4-df3f325983dc"),
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "2104e0ca-5fb6-4eae-a61e-dde887040d0f",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEL20HPbZAiTf4rLEHrZx3PXIzQD6cyM72c4C5kqowjltjGI1QkaDK/WPnvHMBEpAuQ==",
                        ...
                        new
                        {
                            Id = new Guid("69bd714f-9576-45ba-b5b7-f00649be00de"),
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "2a585c6a-7171-4ceb-bbbd-0250e7469f64",
                            Dob = new DateTime(2003, 4, 9, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "hieumai09042003@gmail.com",
                            EmailConfirmed = true,
                            FirstName = "Hao",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEBQc0Hqkg822FOZ1cPpN+mRUUalXWosOtp1y896vEN7tEu76iaHEAHJ9hoDeZDYzSw==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "",
                            TwoFactorEnabled = false,
                        ...
                        new
                        {
                            Id = new Guid("8dbdfeba-e424-4e2c-9931-cdde4472daa6"),
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "f89836e5-43b3-4530-aa8f-696b47fe60d9",
                            Dob = new DateTime(2003, 4, 9, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "hieumai09042003@gmail.com",
                            EmailConfirmed = true,
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAECyPPYpnnHlTQKvb8OXJSxfqPWSePid711ruGqNA7et/h+poLEo3383MVoFJ3u9iDg==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "",
                            TwoFactorEnabled = false,
            ...
            modelBuilder.Entity("MagicPost__Data.Entities.Log", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateCreated = new DateTime(2023, 12, 12, 0, 14, 46, 653, DateTimeKind.Local).AddTicks(3701),
                        ...
                        {
                            Id = 2,
                            DateCreated = new DateTime(2023, 12, 12, 0, 14, 46, 653, DateTimeKind.Local).AddTicks(3703),
            ...
            modelBuilder.Entity("MagicPost__Data.Entities.Order", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            KhoiLuong = 1.2,
                            LogId = 1,
                            OrderDate = new DateTime(2023, 12, 12, 0, 14, 46, 653, DateTimeKind.Local).AddTicks(3575),
                        ...
                        new
                        {
                            ...
                            KhoiLuong = 1.2,
                            LogId = 2,
                            OrderDate = new DateTime(2023, 12, 12, 0, 14, 46, 653, DateTimeKind.Local).AddTicks(3595),
                            ReceiveAddress = "Xuan Thuy",
                            ReceiveName = "Hao",
