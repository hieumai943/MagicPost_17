...
namespace MagicPost__Data.Migrations
{
    ...
    [Migration("20231209095421_Add2Diem")]
    partial class Add2Diem
    {
            ...
            modelBuilder.Entity("MagicPost__Data.Entities.AppRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "eb41ef76-cd3f-4ee1-8aea-9647c001e8d1",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "9a6f3f4e-6064-4e66-be2a-8a332e9a87c1",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "83f76a88-d584-4f0e-8d2d-862856e105b0",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "4fdd5113-08e9-4b3d-a6b1-df9d398c8b6d",
            ...
            modelBuilder.Entity("MagicPost__Data.Entities.AppUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("8d04dce2-969a-435d-bba4-df3f325983dc"),
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "6692079c-9675-4d29-9f16-2a1ad9391597",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEFh94DGFfndst13GtWAJLtMxRPCSMQrOSduQVEglIJEOqawDEO3yW4EgQzCIYGCUGA==",
            ...
            modelBuilder.Entity("MagicPost__Data.Entities.Order", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Cuoc = 100000m,
                            KhoiLuong = 1.2,
                            OrderDate = new DateTime(2023, 12, 9, 16, 54, 19, 642, DateTimeKind.Local).AddTicks(7695),
